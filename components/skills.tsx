...
export function Skills() {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      const ctx = gsap.context(() => {
        ...
        const subtitleElement = skillsRef.current?.querySelector('.skills-subtitle');
        if (subtitleElement) {
          gsap.fromTo(
            subtitleElement,
            { opacity: 0, y: 30 },
        ...
        const skillsContainer = skillsRef.current?.querySelector('.skills-container');
        if (skillsContainer) {
          gsap.fromTo(
            skillsContainer,
            { opacity: 0, y: 30 },
  ...
  return (
    <section id="skills" ref={skillsRef} className="py-12 sm:py-16 md:py-20 overflow-hidden">
