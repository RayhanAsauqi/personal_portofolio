...
const experiences: ExperienceState[] = [
  {
    ...
    description:
      'Developing an AI-powered CMS for Kacamatamoo with Odoo ERP integration to sync eyewear stock, frames, lenses, and store data. The system features an AI recommendation engine with configurable matrices for face shape, skin tone, and measurement parameters, along with store account management.',
    type: 'Contract',
  },
  {
